...
# The functions to write DICOM Segmentation object is most based on the
# implementation demo'ed at RSNA 2019.
...
def create_multiframe_metadata(dicom_file, input_ds):
    ...
    descr = "CAUTION: Research Use Only. NVIDIA Clara generated DICOM SEG"
