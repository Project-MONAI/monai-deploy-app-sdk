...
class SeriesConverter:
    ...
    def series_to_image(self,
        ...
        STAGE_NAME = 'Dicom Series to Image'
        ...
        perf_logger.stage_ended(STAGE_NAME, STAGE_NAME)
    ...
    def write_image(self, series_id, instance_paths, output_dir, out_format='mhd'):
        ...
        STAGE_NAME_CONV_IMAGE = 'Converting Image'
        ...
        perf_logger.stage_ended(STAGE_NAME_CONV_IMAGE, STAGE_NAME_CONV_IMAGE)
