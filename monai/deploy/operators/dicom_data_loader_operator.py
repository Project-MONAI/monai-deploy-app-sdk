...
class DICOMDataLoaderOperator(Operator):
    ...
    def populate_series_attributes(self, series, sop_instance):
        ...
        try:
            ...
            if tag_pixel_spacing in sop_instance: pixel_spacing_de = sop_instance[tag_pixel_spacing]
            elif tag_imager_pixel_spacing in sop_instance: pixel_spacing_de = sop_instance[tag_imager_pixel_spacing]
            else:
                raise KeyError(
